...
class HeightTool extends base_1.AnnotationTool {
    constructor(toolProps = {}, defaultToolProps = {
        ...
        this.addNewAnnotation = (evt) => {
            ...
            const annotation = {
                highlighted: true,
                invalidated: true,
                metadata: Object.assign(Object.assign({}, viewport.getViewReference({ points: [worldPos] })), { toolName: this.getToolName(), referencedImageId,
                    viewUp,
                    cameraPosition }),
                data: {
                    handles: {
        ...
        this.renderAnnotation = (enabledElement, svgDrawingHelper) => {
            ...
            for (let i = 0; i < annotations.length; i++) {
                ...
                const heightUID = '0';
                (0, drawingSvg_1.drawHeight)(svgDrawingHelper, annotationUID, heightUID, canvasCoordinates[0], canvasCoordinates[1], {
                    color,
                    width: lineWidth,
                    lineDash: lineDash,
                });
    ...
    _calculateCachedStats(annotation, renderingEngine, enabledElement) {
        ...
        for (let i = 0; i < targetIds.length; i++) {
            ...
            const { scale, units } = (0, getCalibratedUnits_1.getCalibratedLengthUnitsAndScale)(image, handles);
...
function defaultGetTextLines(data, targetId) {
    ...
    const textLines = [`${(0, utilities_1.roundNumber)(height)} ${unit}`];
    return textLines;
}
HeightTool.toolName = 'Height';
exports.default = HeightTool;
//# sourceMappingURL=HeightTool.js.map